...
public class AgentChartToolService {
    ...
    public String generateChart(String chartType, String dataJson, String title) {
        LOGGER.info("Agent generateChart: chartTypeLength={}, titleLength={}, dataLength={}",
                lengthOf(chartType), lengthOf(title), lengthOf(dataJson));
        ...
        try {
            ...
            throw new IllegalStateException("图表生成失败", e);
        }
    }
