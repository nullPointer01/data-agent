...
核心依赖可以从 `data-agent/pom.xml` 里看到：`spring-boot-starter-web`、`spring-boot-starter-data-jpa`、`spring-boot-starter-security`、`langchain4j-open-ai`、`langchain4j-milvus`、`mysql-connector-j`、`poi-ooxml`、`pdfbox` 等。
...
- Embedding：`EmbeddingGateway`，支持本地 AllMiniLmL6V2 和 API 模式
